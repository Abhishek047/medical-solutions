      ...
      <div className={card.content}>
        ...
        <div className={card['content-item']}>
          <Typography type="body1" gutterBottom={false}>
            Dimensions : {dimensions.length}cm x {dimensions.width}cm x{' '}
            {dimensions.height}cm <br />
        ...
        <div className={card['content-item']}>
          <div className={card['button-grp']}>
            <Button
              ...
              color="primary"
              size="small"
              className={card['button-grp__item']}
              endIcon={<ShoppingBag width={'0.9rem'} />}
            >
              {price ? price : 'Contact'}
            </Button>
            <Link className={card['button-grp__item']} href={`/product/${id}`}>
              <Button
                type="filled"
                color="primary"
                size="small"
